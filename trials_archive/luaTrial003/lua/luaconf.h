...
/* Teensy 4.1 (ARM) 用の追加設定 */
  ...
  /* リンクエラー（_open, _unlink等）の直接的な回避策 */
  #include <stdio.h>
  #define LUA_USE_C89
  
  /* 標準ライブラリが内部で呼ぼうとする低層関数を無効化 */
  #define stdin  ((FILE*)NULL)
  #define stdout ((FILE*)NULL)
  #define stderr ((FILE*)NULL)
  #define fopen(f,m) NULL
  #define freopen(f,m,s) NULL
  #define fclose(s) 0
  #define fflush(s) 0
  ...
  #define fputc(c,s) EOF
  #define fputs(s,f) 0
  #define fprintf(f,...) 0
  /* stdio.hとの整合性 */
  #include <stdio.h>
  #define tmpnam(x) NULL
#endif
/* =================================================================== */
#endif
